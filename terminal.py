...
# Place this file here: /usr/share/terminator/terminatorlib/terminal.py
# to make right click paste possible
...
class Terminal(gtk.VBox):
    ...
    def on_buttonpress(self, widget, event):
        ...
        if event.button == 1:
            ...
            # rightclick should paste the clipboard if Ctrl is not pressed
            if event.state & gtk.gdk.CONTROL_MASK == 0:
                self.paste_clipboard(True)
                return(True)
            # rightclick should display a context menu if Ctrl IS pressed
            elif event.state & gtk.gdk.CONTROL_MASK == gtk.gdk.CONTROL_MASK:
